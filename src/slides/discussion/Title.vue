...
<template>
    <article>
        ...
        <h1 class="sub-title glitched" data-text="Round Two">Round Two</h1>
    </article>
</template>
...
.sub-title {
    ...
    color: #ff8bd3;
    margin-top: 0.5em;
    text-shadow: 0 0 10px rgba(255, 52, 177, 0.5);
}
.glitched {
...
.glitched::after {
    ...
    animation: glitch-crop 1530ms step-end 0s infinite both,
        glitch-opacity 3340ms step-end 0s infinite both;
